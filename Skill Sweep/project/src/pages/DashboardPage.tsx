...
// import { FileText, Users, MessageSquare, FileCheck, Briefcase } from 'lucide-react';
...
//             key={index}
//             to={card.link}
//             className={`${card.color} p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200`}
//           >
...
//           <h2 className="ml-3 text-lg font-medium text-gray-900">Quick Actions</h2>
//         </div>
