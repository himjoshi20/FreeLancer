...
const ServiceRequestPage: React.FC = () => {
  ...
  const [currentUserId] = useState('user-1'); // This should come from auth context
  ...
  const handleSendMessage = async (message: string) => {
    ...
    await sendChatMessage(selectedRequest.id, message, currentUserId);
    loadMessages(selectedRequest.id);
  };
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-8">Service Requests & Negotiations</h1>
